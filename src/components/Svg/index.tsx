...
export { default as FeeIcon } from "./Icons/Fee";
...
export { default as OgeefinancesIcon } from "./Icons/Ogeefinances";
export { default as OgeefinanceRoundIcon } from "./Icons/OgeefinanceRound";
